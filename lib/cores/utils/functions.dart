...
import '../../../cores/presentation/components/overview_section.dart';
...
import '../../features/tv_shows/presentation/views/tv_show_details_view.dart';
...
void navigateToDetailsView(
    {required BuildContext context, required bool isMovie, required int id}) {
  showDialog(
    context: context,
    builder: (context) {
      return Dialog(
